...
Class Facebook
{
    ...
    public function __construct(){
        ...
        if (!isset($this->fb)){
            ...
            $facebook_app_id = isset($siteSetting->facebook_app_id) && $siteSetting->facebook_app_id?$siteSetting->facebook_app_id:'-';
            $facebook_app_secret = isset($siteSetting->facebook_app_secret) && $siteSetting->facebook_app_secret?$siteSetting->facebook_app_secret:'-';
            $this->fb = new FB([
