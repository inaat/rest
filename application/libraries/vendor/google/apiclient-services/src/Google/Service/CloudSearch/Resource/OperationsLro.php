 ...
 *  </code>
 */
class Google_Service_CloudSearch_Resource_OperationsLro extends Google_Service_Resource
{
  /**
  ...
  public function listOperationsLro($name, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "Google_Service_CloudSearch_ListOperationsResponse");
  }
}
