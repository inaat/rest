...
class Google_Service_TrafficDirectorService_ClientStatusRequest extends Google_Collection
{
  protected $collection_key = 'nodeMatchers';
  protected $nodeMatchersType = 'Google_Service_TrafficDirectorService_NodeMatcher';
