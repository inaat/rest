...
class Google_Service_DisplayVideo_ExchangeConfig extends Google_Collection
{
  protected $collection_key = 'enabledExchanges';
  protected $enabledExchangesType = 'Google_Service_DisplayVideo_ExchangeConfigEnabledExchange';
