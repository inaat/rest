...
class Google_Service_TrafficDirectorService_ScopedRoutesConfigDump extends Google_Collection
{
  protected $collection_key = 'inlineScopedRouteConfigs';
  protected $dynamicScopedRouteConfigsType = 'Google_Service_TrafficDirectorService_DynamicScopedRouteConfigs';
  protected $dynamicScopedRouteConfigsDataType = 'array';
  protected $inlineScopedRouteConfigsType = 'Google_Service_TrafficDirectorService_InlineScopedRouteConfigs';
