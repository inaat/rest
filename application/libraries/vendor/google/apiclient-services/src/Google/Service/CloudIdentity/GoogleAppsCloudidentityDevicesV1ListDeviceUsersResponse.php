...
class Google_Service_CloudIdentity_GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse extends Google_Collection
{
  protected $collection_key = 'deviceUsers';
  protected $deviceUsersType = 'Google_Service_CloudIdentity_GoogleAppsCloudidentityDevicesV1DeviceUser';
