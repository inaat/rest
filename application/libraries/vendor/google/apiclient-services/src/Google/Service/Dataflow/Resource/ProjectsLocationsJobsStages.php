 ...
 *  </code>
 */
class Google_Service_Dataflow_Resource_ProjectsLocationsJobsStages extends Google_Service_Resource
{
  /**
  ...
  {
    $params = array('projectId' => $projectId, 'location' => $location, 'jobId' => $jobId, 'stageId' => $stageId);
    $params = array_merge($params, $optParams);
    return $this->call('getExecutionDetails', array($params), "Google_Service_Dataflow_StageExecutionDetails");
  }
}
