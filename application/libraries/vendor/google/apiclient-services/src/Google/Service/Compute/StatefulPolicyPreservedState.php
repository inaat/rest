...
class Google_Service_Compute_StatefulPolicyPreservedState extends Google_Model
{
  protected $disksType = 'Google_Service_Compute_StatefulPolicyPreservedStateDiskDevice';
