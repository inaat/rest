...
class Google_Service_DisplayVideo_BulkEditAssignedUserRolesResponse extends Google_Collection
{
  protected $collection_key = 'createdAssignedUserRoles';
  protected $createdAssignedUserRolesType = 'Google_Service_DisplayVideo_AssignedUserRole';
