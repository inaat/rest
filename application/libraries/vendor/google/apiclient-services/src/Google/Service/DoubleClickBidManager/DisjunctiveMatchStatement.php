...
class Google_Service_DoubleClickBidManager_DisjunctiveMatchStatement extends Google_Collection
{
  protected $collection_key = 'eventFilters';
  protected $eventFiltersType = 'Google_Service_DoubleClickBidManager_EventFilter';
