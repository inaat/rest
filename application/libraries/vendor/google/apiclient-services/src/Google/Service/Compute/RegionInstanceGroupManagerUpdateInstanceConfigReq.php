...
class Google_Service_Compute_RegionInstanceGroupManagerUpdateInstanceConfigReq extends Google_Collection
{
  protected $collection_key = 'perInstanceConfigs';
  protected $perInstanceConfigsType = 'Google_Service_Compute_PerInstanceConfig';
