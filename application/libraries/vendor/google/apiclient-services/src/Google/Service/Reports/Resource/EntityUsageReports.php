...
class Google_Service_Reports_Resource_EntityUsageReports extends Google_Service_Resource
{
   ...
   * value],.... In this example, the <> 'not equal to' operator is URL-encoded in
   * the request's query string (%3C%3E): GET https://www.googleapis.com/admin/rep
   * orts/v1/usage/gplus_communities/all/dates/2017-12-01
   * ?parameters=gplus:community_name,gplus:num_total_members
   * =gplus:num_total_members>0 The relational operators include: - == - 'equal
   * to'. - <> - 'not equal to'. It is URL-encoded (%3C%3E). - < - 'less than'. It
   * is URL-encoded (%3C). - <= - 'less than or equal to'. It is URL-encoded
