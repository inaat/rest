...
class Google_Service_CloudHealthcare_Resource_ProjectsLocationsDatasetsFhirStoresFhir extends Google_Service_Resource
{
   ...
   * [R4](http://hl7.org/implement/standards/fhir/R4/search.html)). Supports three
   ...
   * resources of a specified type. * `POST [base]/[type]/_search?[parameters]` as
   * an alternate form having the same semantics as the `GET` method. The `GET`
