...
class Google_Service_CloudIdentity_GoogleAppsCloudidentityDevicesV1ListClientStatesResponse extends Google_Collection
{
  protected $collection_key = 'clientStates';
  protected $clientStatesType = 'Google_Service_CloudIdentity_GoogleAppsCloudidentityDevicesV1ClientState';
