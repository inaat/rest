...
class Google_Service_TrafficDirectorService_ClientStatusResponse extends Google_Collection
{
  protected $collection_key = 'config';
  protected $configType = 'Google_Service_TrafficDirectorService_ClientConfig';
