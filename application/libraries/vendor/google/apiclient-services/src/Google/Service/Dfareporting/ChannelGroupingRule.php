...
class Google_Service_Dfareporting_ChannelGroupingRule extends Google_Collection
{
  protected $collection_key = 'disjunctiveMatchStatements';
  protected $disjunctiveMatchStatementsType = 'Google_Service_Dfareporting_DisjunctiveMatchStatement';
