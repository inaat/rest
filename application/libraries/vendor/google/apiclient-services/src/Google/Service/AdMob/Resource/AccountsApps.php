...
{
  /**
   * Retrieves the specified app. (apps.get)
   *
   * @param string $name Required. Resource name of the app to retrieve. Example:
  ...
  public function get($name, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "Google_Service_AdMob_App");
  }
  /**
   ...
   * @opt_param int pageSize The maximum number of apps to return.
