...
class Google_Service_Reports_Resource_UserUsageReport extends Google_Service_Resource
{
   ...
   * the request's query string (%3C%3E): GET
   * https://www.googleapis.com/admin/reports/v1/usage/users/all/dates/2013-03-03
   * ?parameters=accounts:last_login_time
   * =accounts:last_login_time>2010-10-28T10:26:35.000Z The relational operators
   * include: - == - 'equal to'. - <> - 'not equal to'. It is URL-encoded
   * (%3C%3E). - < - 'less than'. It is URL-encoded (%3C). - <= - 'less than or
   * equal to'. It is URL-encoded (%3C=). - > - 'greater than'. It is URL-encoded
