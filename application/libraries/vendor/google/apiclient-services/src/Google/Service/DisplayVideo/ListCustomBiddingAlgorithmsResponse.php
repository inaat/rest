...
class Google_Service_DisplayVideo_ListCustomBiddingAlgorithmsResponse extends Google_Collection
{
  protected $collection_key = 'customBiddingAlgorithms';
  protected $customBiddingAlgorithmsType = 'Google_Service_DisplayVideo_CustomBiddingAlgorithm';
