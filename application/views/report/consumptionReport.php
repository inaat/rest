            ...
            <div class="table-responsive">
                ...
                <table id="datatable" class="table">
                    ...
                    <tr>
                        ...
                        <th><?php echo lang('total'); ?> <?php echo lang('cost'); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    if (isset($consumptionMenus)):
                        foreach ($consumptionMenus as $key => $value) {
                            ...
                            $totalTK +=($value->total_consumption);
                            $key++;
                            ?>
                            <tr>
                                <td class="ir_txt_center"><?php echo escape_output($key); ?></td>
                                <td><?php echo escape_output($value->ingredient_name).' '.$value->ingredient_code; ?></td>
                                <td><?php echo escape_output(getAmtP($value->total_consumption_qty)) ?><?php echo escape_output(unitName(getUnitIdByIgId($value->ingredient_id))) ?></td>
                    ...
                    <tr>
                        ...
                        <th><?php echo escape_output(getAmtP($totalTK)) ?></th>
                    </tr>
                    </tfoot>
                </table>
            </div>
                    ...
                    if (isset($consumptionModifiers)):
                        foreach ($consumptionModifiers as $key => $value) {
                            ...
                            <tr>
                                <td class="ir_txt_center"><?php echo escape_output($key); ?></td>
                                <td><?php echo escape_output($value->ingredient_name).' '.$value->ingredient_code; ?></td>
                                <td><?php echo escape_output(getAmtP($value->total_consumption_qty)) ?></td>
                                <td><?php echo escape_output(getAmtP($value->total_consumption)) ?></td>
                            </tr>
                            <?php
                        }
