...
<section class="main-content-wrapper">
    ...
    <div class="box-wrapper">
        <div class="table-box">
            ...
            ?>
            <?php echo form_open(base_url() . 'Frontend/emailSetting/'.(isset($company_id) && $company_id?$company_id:''), $arrayName = array('id' => 'add_whitelabel','enctype'=>'multipart/form-data')) ?>
            <div class="box-body">
