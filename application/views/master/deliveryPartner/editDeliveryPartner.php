...
<section class="main-content-wrapper">
    <section class="content-header">
        <h3 class="top-left-header">
            <?php echo lang('editDeliveryPartner'); ?>
        </h3>
    </section>
    ...
    <div class="box-wrapper">
        ...
        <div class="table-box">
            <!-- form start -->
            <?php echo form_open(base_url() . 'deliveryPartner/addEditDeliveryPartner/'. $encrypted_id, $arrayName = array('id' => 'edit_category','enctype'=>'multipart/form-data')) ?>
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12 mb-2 col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input tabindex="1" type="text" name="name" class="form-control"
                                ...
                                value="<?php echo escape_output($category_information->name) ?>">
                        </div>
                    ...
                    <input type="hidden" name="old_logo" value="<?php echo escape_output($category_information->logo); ?>">
                    <div class="col-sm-12 mb-2 col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-sm-12 mb-2 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            ><?php echo escape_output($category_information->description) ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
