<section class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row">
            <div class="col-sm-12">
                <h2 class="top-left-header"><?php echo lang('denominations'); ?> </h2>
                <input type="hidden" class="datatable_name" data-title="<?php echo lang('denominations'); ?>" data-id_name="datatable">
            </div>
            <div>
