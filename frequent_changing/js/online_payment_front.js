$(function() {
    ...
    $(document).on('click', '.payment_now', function(e) {
        ...
        let term_condition = $('#term_condition:checked').val();
        //error list
        ...
        if(term_condition != 'on'){
            status = true;
            swal({
                title: warning,
                text: 'Please make sure you are agree with terms and conditions!',
