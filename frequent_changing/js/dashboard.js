$(function () {
  ...
  let dashboard_chart_color = $("#dashboard_chart_color").val().substring(0, 7); // Extract #RRGGBB
  let base_color = $("#base_color").val().substring(0, 7);
  let base_color2 = $("#base_color2").val().substring(0, 7);
  let sale = $("#sale").val();
  let waste = $("#waste").val();
